...
function LoginScreen({navigation}) {
    ...
    function afterLogin(SignedInUser) {
    ...
    async function OnGoogleButtonPress() {
        try {
           ...
           // console.log(_user);
            afterLogin(firebaseUserCredential.user); // Replace with your function name
    ...
    return (
        <View style={{justifyContent:'center',alignItems:'center',flex:1}}>
            <Icon name="translate" color="aqua" size={100}/>
              <Text style={{fontSize:30}}>Translation Appp</Text>
            <GoogleSigninButton
